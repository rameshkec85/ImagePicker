...
public class ImageAdapter extends BaseAdapter {
    ...
    public void addAlbums(List<ImageEntry> albumEntryList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View album_detail_layout = view.findViewById(R.id.album_detail_layout);
        ...
        if (imageEntry.getPath() != null) {
            Glide.with(mContext)
                    .load(imageEntry.getPath())
                    .centerCrop()
                    .crossFade()
